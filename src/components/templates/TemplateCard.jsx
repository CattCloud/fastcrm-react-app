...
export const TemplateCard = ({ template, onEdit, onDelete, canModify }) => {
  ...
  return (
    <Card hoverable className="p-4 relative">
      ...
      <p className="text-[#263238] text-sm mb-3 line-clamp-3">
        {template.content}
      </p>
      ...
      <div className="text-xs text-[#90A4AE] flex items-center justify-between">
