...
import { User, Phone, Calendar, Building, Trash2, MoreVertical } from 'lucide-react';
        ...
        <Card hoverable className="p-4 relative">
            ...
            {contact.companyName && (
                <div className="mb-4">
                    ...
                    <p className="font-sans text-[#263238] bg-[#F1F8E9] px-3 py-2 rounded border border-[#C5E1A5]">
                        {contact.companyName}
                    </p>
                </div>
            )}
